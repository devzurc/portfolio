---
name: prompt-add-project
description: Adds a new project card to the portfolio #projects section. Use when adding a new portfolio project with EN/PT copy and stack tags.
...
@.agents/skills/copywriting-linkedin/SKILL.md
@.agents/skills/frontend-maintenance/SKILL.md
...
@.agents/skills/prompt-add-project/SKILL.md
@.agents/rules.md
```
