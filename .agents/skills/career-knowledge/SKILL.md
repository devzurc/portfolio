...
description: Curates GitHub projects and syncs career data for portfolio and CV alignment. Use when curating GitHub projects, syncing career data, or preparing portfolio/CV alignment from work evidence.
---
