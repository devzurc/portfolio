---
name: prompt-continuous-career-sync
description: Invokes a continuous career sync pass across GitHub, CV, cover letter, and portfolio. Use for /continuous-career-sync or when the user wants a GitHub-to-career sync run.
...
@.agents/skills/continuous-career-sync/SKILL.md
@.agents/skills/career-knowledge/SKILL.md
@.agents/skills/cv-management/SKILL.md
