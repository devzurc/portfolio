---
name: prompt-review-before-commit
description: Reviews git diff before commit for factual integrity, bilingual parity, and regressions. Use for /pre-commit-review or before committing portfolio changes.
...
@.agents/skills/seo-accessibility/SKILL.md
...
@.agents/skills/prompt-review-before-commit/SKILL.md
