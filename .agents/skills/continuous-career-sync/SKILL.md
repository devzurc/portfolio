...
Use `@.agents/skills/career-knowledge/SKILL.md` for project curation and `@.agents/skills/cv-management/SKILL.md` before changing CV-related content.
...
1. Read `@.agents/rules.md`, `@.agents/project-context.md`, this skill, `@.agents/skills/career-knowledge/SKILL.md`, and `@.agents/skills/cv-management/SKILL.md`.
2. Run:
...
| AI platform repo appears or updates | Route to `docs/career/goals/projects-pipeline.md` via `@.agents/skills/ai-roadmap-tracking/SKILL.md`; update skill matrix when proven |
